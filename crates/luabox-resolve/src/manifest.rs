...
mod tests {
    ...
    #[test]
    fn version_only_table_still_rejects_orphan_source_modifiers() {
        // A git reference or digest without its source stays an error even
        // when `version` is present — the modifier names the missing source.
