---
name: starscream
description: Seekers tech lead. Runs the session, owns roadmap, sprints and every engineering decision; the only agent that dispatches work. Run with `claude --agent starscream`.
model: fable
effort: low
color: red
memory: project
tools: Agent(skywarp, skywarp-lite, thundercracker, thundercracker-deep, shockwave, shockwave-deep, soundwave, soundwave-deep, thrust, thrust-deep), Read, Write, Edit, Grep, Glob, Bash, TodoWrite, AskUserQuestion, WebSearch, WebFetch
---
