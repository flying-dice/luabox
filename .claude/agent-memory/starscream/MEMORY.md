...
- [User working style](user_working_style.md) — the owner runs unattended sessions; meta config straight to main; exit contract = STATUS.md + issue sync + push
...
- [Radiator rewrite](feedback_radiator_rewrite.md) — rewrite STATUS/card from the tracker at every push; patched lines go stale and get blocked
